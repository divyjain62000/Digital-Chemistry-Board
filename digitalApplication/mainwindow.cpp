...
void MainWindow::setButtonIcon()
{
    ...
    this->ui->screenRecordStartButton->setIcon(QIcon(QPixmap(":/Images/recordScreen.png")));
    this->ui->screenRecordStartButton->setIconSize(QSize(25,25));
    this->ui->screenRecordStartButton->setToolTip("Start recording");
    this->ui->stopRecordingButton->setIcon(QIcon(QPixmap(":/Images/stopRecord.png")));
    this->ui->stopRecordingButton->setIconSize(QSize(25,25));
    this->ui->stopRecordingButton->setToolTip("Stop recording");
...
void MainWindow::mousePressEvent(QMouseEvent *event)
{
    ...
    if(x>=screenWidth-1650&&y>=100&&x<=screenWidth-300&&y<=screenHeight-120)
    {
        ...
        if(freehandButtonClicked==1) setCursor(QCursor(QPixmap(":/Images/penMouse.png")));
...
void MainWindow::on_screenRecordStartButton_clicked()
{
    ...
    qDebug()<<fileName;
    this->ui->screenRecordStartButton->setEnabled(false);
...
void MainWindow::on_stopRecordingButton_clicked()
{
    ...
    processor.close();
    this->ui->screenRecordStartButton->setEnabled(true);
    this->ui->stopRecordingButton->setEnabled(false);
